...
// PSID Getter Prototype
int sceOpenPSIDGetOpenPSID(unsigned char * buffer);
...
void paintList(int withclear)
{
	...
	sprintf(serialnumber, "Serial Number: %08X", getSerialNumber());
